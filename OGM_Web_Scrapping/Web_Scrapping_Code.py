...
# Ayarlar ve Yollar
pdf_url = "https://ogm-large-cdn.eba.gov.tr/ogm-materyal/tarama/tyt-turkce/tyt-turkce.pdf"
pdf_path = "tyt-turkce.pdf"
klasor_adi = "cosmos_t2_sorular"

# Klasörü oluştur
os.makedirs(klasor_adi, exist_ok=True)

# 1. AŞAMA: PDF'i İndirme
if not os.path.exists(pdf_path):
    ...
    if response.status_code == 200:
        ...
        print(f"Hata: PDF indirilemedi (Durum Kodu: {response.status_code})")
        exit() # İndiremezse kodu durdur
else:
